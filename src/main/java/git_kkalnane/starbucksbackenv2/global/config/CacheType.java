...
public enum CacheType {
    ...
    /**
     * 개별 매장 조회 캐시 - 실제 매장 수: 10개 - 여유분 포함: 30개로 설정<br>
     * <br>
     * 주문 진행 시 자주 사용되는 핵심 캐시
     */
    STORES("stores", 120, 30),

    /**
     * 매장 목록 조회 캐시 (페이징) - 매장 10개 ÷ 15개 페이징 = 1페이지 - 다양한 정렬 옵션 고려<br>
     * <br>
     * 1페이지 × 2가지 정렬(매장명, 거리순) = 2개 + 여유분 = 10개로 설정
     */
    STORE_LIST("storeList", 120, 10);
